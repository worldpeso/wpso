...
In order to support loading of multiple wallets in wpso-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wpso.cpp.
...
wpso.cpp is the entry point into wpso-qt, and as such, will require some minor modifications to provide hooks for
