...
RESOURCES += src/qt/wpso.qrc src/qt/wpso_locale.qrc

TRANSLATIONS += src/qt/locale/wpso_bg.ts \
                src/qt/locale/wpso_de.ts \
                src/qt/locale/wpso_en.ts \
                src/qt/locale/wpso_es.ts \
                src/qt/locale/wpso_fi.ts \
                src/qt/locale/wpso_fr.ts \
                src/qt/locale/wpso_it.ts \
                src/qt/locale/wpso_ja.ts \
                src/qt/locale/wpso_pl.ts \
                src/qt/locale/wpso_pt.ts \
                src/qt/locale/wpso_ru.ts \
                src/qt/locale/wpso_sk.ts \
                src/qt/locale/wpso_sv.ts \
                src/qt/locale/wpso_vi.ts \
                src/qt/locale/wpso_zh_CN.ts \
                src/qt/locale/wpso_zh_TW.ts