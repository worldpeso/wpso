...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* wpso features */
        {"wpso", "masternode", &masternode, true, true, false},
        {"wpso", "masternodelist", &masternodelist, true, true, false},
        {"wpso", "mnbudget", &mnbudget, true, true, false},
        {"wpso", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"wpso", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wpso", "mnsync", &mnsync, true, true, false},
        {"wpso", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"wpso", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wpsod, or the -server option to wpso-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wpso-cli " + methodname + " " + args + "\n";
}
