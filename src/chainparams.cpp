...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 27111;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // wpso starting difficulty is 1 / 2^12  //20
        ...
        nMinerThreads = 0;
        nTargetTimespan = 4 * 60; // wpso: 4 minutes
        nTargetSpacing = 2 * 60;  // wpso: 2 minute
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        strDeveloperFeePayee = "WVPFLzTkuxrsreEkxNbNYM6SvJG7cv8gEQ";

        const char* pszTimestamp = "World Peso 2021 Cryptocurrency, secure and fast transactions asset";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1609369401;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21022228;
		
		
		
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000879d3e66b9d90ad4716a9afb905cb4a79d9298900e4cab7f2fb69c23b54"));
        assert(genesis.hashMerkleRoot == uint256("0xdd5ff70925a9225871ee54252f05fc322c47b75721de7b539bd1bcff2dc4f6a7"));
	
       	// New Seed Nodes added 17/02/2019	
	vSeeds.push_back(CDNSSeedData("178.62.76.54", "178.62.76.54"));  
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10*6; // wpso: 60 seconds
        nTargetSpacing = 10*6;  // wpso: 60 seconds
        nLastPOWBlock = 2000;
        nMaturity = 15;
        ...
        // Testnet wpso BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet wpso BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet wpso BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 5 * 60; // wpso: 5 minutes
        nTargetSpacing = 1 * 60;  // wpso: 1 minute
