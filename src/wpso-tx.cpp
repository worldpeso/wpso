...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("wpso Core wpso-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wpso-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wpso transaction") + "\n" +
                               "  wpso-tx [options] -create [commands]   " + _("Create hex-encoded wpso transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wpso transaction
