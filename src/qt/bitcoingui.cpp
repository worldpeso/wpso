...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a wpso address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wpso:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About wpso Core"), this);
    aboutAction->setStatusTip(tr("Show information about wpso Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for wpso"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your wpso addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified wpso addresses"));
    ...
    openAction->setStatusTip(tr("Open a wpso:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the wpso Core help message to get a list with possible wpso command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("wpso Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to wpso network", "", count));
}
...
{
    QString strTitle = tr("wpso"); // default title
